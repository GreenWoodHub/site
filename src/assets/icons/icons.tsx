...
export function StarIcon(props: IconProps) {
  return (
    <svg fill={defaultStroke} viewBox="0 0 24 24" {...props}>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth={2}
...
export function MeetupIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 512 512" fillRule="evenodd" clipRule="evenodd" {...props}>
      <path
        fill={props.fill ?? "#FF4A79"}
